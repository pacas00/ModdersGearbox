...
namespace plugin_petercashel_ModdersGearbox.Features.CustomBlockTextures.HD
{
	...
	public class SetUVOnCubeToTerrainIndex_HD
	{
		...
		public static void StoreCubeMesh(GameObject cube)
		{
			...
			SetUVOnCubeToTerrainIndex_HD.cubeMesh = component.mesh;
		...
		{
			SegmentMeshCreator.instance.RenderCustomDesign(design, ref SetUVOnCubeToTerrainIndex_HD.customMeshes, ref SetUVOnCubeToTerrainIndex_HD.customMaterials);
			MeshFilter component = lCubeObject.transform.GetComponent<MeshFilter>();
			component.mesh = SetUVOnCubeToTerrainIndex_HD.customMeshes[0];
			MeshRenderer component2 = lCubeObject.transform.GetComponent<MeshRenderer>();
			component2.material = SetUVOnCubeToTerrainIndex_HD.customMaterials[0];
			SetUVOnCubeToTerrainIndex_HD.mpb.SetColor("_Color", Color.white);
			component2.SetPropertyBlock(SetUVOnCubeToTerrainIndex_HD.mpb);
		}
		...
		public static void SetUVOnly(int cubeType, ushort cubeValue, GameObject lCubeObject)
		{
			...
			SetUVOnCubeToTerrainIndex_HD.SetFrontUV(cubeType, cubeValue, num2, lnGutter, ref array);
			SetUVOnCubeToTerrainIndex_HD.SetBackUV(cubeType, cubeValue, num2, lnGutter, ref array);
			SetUVOnCubeToTerrainIndex_HD.SetLeftUV(cubeType, cubeValue, num2, lnGutter, ref array);
			SetUVOnCubeToTerrainIndex_HD.SetRightUV(cubeType, cubeValue, num2, lnGutter, ref array);
			SetUVOnCubeToTerrainIndex_HD.SetBotUV(cubeType, cubeValue, num2, lnGutter, ref array);
			SetUVOnCubeToTerrainIndex_HD.SetTopUV(cubeType, cubeValue, num2, lnGutter, ref array);
			mesh.uv = array;
		...
		{
			if (SetUVOnCubeToTerrainIndex_HD.mpb == null)
			{
				SetUVOnCubeToTerrainIndex_HD.mpb = new MaterialPropertyBlock();
			}
			if (CubeHelper.IsColorised(cubeType))
			{
				SetUVOnCubeToTerrainIndex_HD.mpb.SetColor("_Color", PlayerPainter.FromValue(cubeValue));
			}
			else
			{
				SetUVOnCubeToTerrainIndex_HD.mpb.SetColor("_Color", Color.white);
			...
			component2.material = SetUVOnCubeToTerrainIndex_HD.cubeMaterial;
			component2.SetPropertyBlock(SetUVOnCubeToTerrainIndex_HD.mpb);
			Mesh mesh = component.mesh;
			Vector2[] uv = mesh.uv;
			SetUVOnCubeToTerrainIndex_HD.SetFrontUV(cubeType, cubeValue, lnTotalPix, lnGutter, ref uv);
			SetUVOnCubeToTerrainIndex_HD.SetBackUV(cubeType, cubeValue, lnTotalPix, lnGutter, ref uv);
			SetUVOnCubeToTerrainIndex_HD.SetLeftUV(cubeType, cubeValue, lnTotalPix, lnGutter, ref uv);
			SetUVOnCubeToTerrainIndex_HD.SetRightUV(cubeType, cubeValue, lnTotalPix, lnGutter, ref uv);
			SetUVOnCubeToTerrainIndex_HD.SetBotUV(cubeType, cubeValue, lnTotalPix, lnGutter, ref uv);
			SetUVOnCubeToTerrainIndex_HD.SetTopUV(cubeType, cubeValue, lnTotalPix, lnGutter, ref uv);
			mesh.uv = uv;
		}
		...
		public static void SetUVAndOverrideMaterial(int cubeType, ushort cubeValue, GameObject lCubeObject)
		{
			...
			Mesh mesh = component.mesh;
			Vector2[] uv = mesh.uv;
			SetUVOnCubeToTerrainIndex_HD.SetFrontUV(cubeType, cubeValue, num2, lnGutter, ref uv);
			SetUVOnCubeToTerrainIndex_HD.SetBackUV(cubeType, cubeValue, num2, lnGutter, ref uv);
			SetUVOnCubeToTerrainIndex_HD.SetLeftUV(cubeType, cubeValue, num2, lnGutter, ref uv);
			SetUVOnCubeToTerrainIndex_HD.SetRightUV(cubeType, cubeValue, num2, lnGutter, ref uv);
			SetUVOnCubeToTerrainIndex_HD.SetBotUV(cubeType, cubeValue, num2, lnGutter, ref uv);
			SetUVOnCubeToTerrainIndex_HD.SetTopUV(cubeType, cubeValue, num2, lnGutter, ref uv);
			mesh.uv = uv;
		}
		...
		public static void SetUVAndOverrideStaticMesh(int cubeType, ushort cubeValue, GameObject lCubeObject)
		{
			...
			int lnTotalPix = 292;
			int lnGutter = 32; //32 if HD?
			MeshFilter component = lCubeObject.GetComponent<MeshFilter>();
			component.mesh = SetUVOnCubeToTerrainIndex_HD.cubeMesh;
			MeshRenderer component2 = lCubeObject.GetComponent<MeshRenderer>();
			if (SetUVOnCubeToTerrainIndex_HD.cubeMaterial == null)
			{
				Debug.LogError("Error, cubeMaterial hasn't been assigned when setting Cube UVs!");
		...
		public static float lnMatPix = 4088f * 2f;

		// Token: 0x04004D6B RID: 19819
		public static float lnMatPiy = 4088f * 2f;

		// Token: 0x04004D6C RID: 19820
		private static int lnTilePix = 128 * 2;

		// Token: 0x04004D6D RID: 19821
		private static int lnTotalPix = 146 * 2;
